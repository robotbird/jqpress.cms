...
namespace Jqpress.Framework.Utils
{
    ...
    {
        //var user={"name":"张三","gender":"男","birthday":"1980-8-8"} json对象
        //var userlist=[{"user":{"name":"张三","gender":"男","birthday":"1980-8-8"}},{"user":{"name":"李四","gender":"男","birthday":"1985-5-8"}}]; json数组
        ...
        public static string DictionaryToJson(Dictionary<string,string> dic) 
        {
            ...
            {
                sb.AppendFormat("\"{0}\":\"{1}\",", kv.Key, JsonCharFilter(kv.Value));
            }
           // sb.ToString().TrimEnd(',');
